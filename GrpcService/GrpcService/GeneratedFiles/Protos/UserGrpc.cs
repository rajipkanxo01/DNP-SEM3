...
namespace GRPCTest {
  public static partial class UserProtoService
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Marshaller<global::GRPCTest.User> __Marshaller_User = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::GRPCTest.User.Parser));
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Marshaller<global::GRPCTest.UpdateUserRequest> __Marshaller_UpdateUserRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::GRPCTest.UpdateUserRequest.Parser));
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Method<global::GRPCTest.User, global::GRPCTest.User> __Method_CreateUser = new grpc::Method<global::GRPCTest.User, global::GRPCTest.User>(
        grpc::MethodType.Unary,
        __ServiceName,
        "CreateUser",
        __Marshaller_User,
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Method<global::GRPCTest.UpdateUserRequest, global::GRPCTest.User> __Method_UpdateUser = new grpc::Method<global::GRPCTest.UpdateUserRequest, global::GRPCTest.User>(
        grpc::MethodType.Unary,
        __ServiceName,
        "UpdateUser",
    ...
    {
      get { return global::GRPCTest.UserReflection.Descriptor.Services[0]; }
    }
    ...
    public abstract partial class UserProtoServiceBase
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::GRPCTest.User> CreateUser(global::GRPCTest.User request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }

      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::GRPCTest.User> UpdateUser(global::GRPCTest.UpdateUserRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, UserProtoServiceBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_CreateUser, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GRPCTest.User, global::GRPCTest.User>(serviceImpl.CreateUser));
      serviceBinder.AddMethod(__Method_UpdateUser, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GRPCTest.UpdateUserRequest, global::GRPCTest.User>(serviceImpl.UpdateUser));
